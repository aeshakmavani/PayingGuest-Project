...
<!DOCTYPE html>
<head>
    <title>Humming House | Owner Login </title>
    ...
    <!-- //bootstrap-css -->
    <!-- Custom CSS -->
    <link href="../owner/css/style1.css" rel='stylesheet' type='text/css' />
...
?> </p>
            ...
            <p class="animated1 flipInX">Don't Have an Account ?<a href="owner-registration.php" class="animated1 flipInX">Create an account</a></p>
        </div>
    </div>
